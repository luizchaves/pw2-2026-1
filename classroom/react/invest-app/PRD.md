...
| Code quality   | Biome handles linting and formatting through `pnpm lint` and `pnpm format`; Husky runs lint-staged with Biome on pre-commit and tests on pre-push. |
